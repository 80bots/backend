<div class="modal fade" id="create-scheduler" role="dialog">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <form id="CreateSchedulerForm" name="CreateSchedulerForm" action="{{route('scheduling.store')}}"
                  method="post">
                @csrf
                ...
                <div class="modal-header">
                    <h4 class="modal-title">
                        {{ __('user.scheduling.create_scheduler') }}&nbsp;<span id="bot-name"></span>
                    </h4>
                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                </div>
                <div class="modal-body">
                    <div class="text-right">
                        <button type="button" onclick="addSchedulerRow()" class="btn btn-success btn-round btn-icon">
