    ...
    <div class="wrapper">
        <div class="card">
            <div class="card-header d-flex align-items-center justify-content-between">
                ...
                <h5 class="mb-0"><a href="{{ route('admin.notification.create') }}" class="btn btn-round btn-primary"><i class="fas fa-plus-circle"></i></a></h5>
            </div>
            <div class="card-body">
                        ...
                        @if(isset($percentages) && !empty($percentages))
                            @foreach($percentages as $percentage)
                                <tr>
                                    ...
                                    <td>
                                        <form action="{{ route('admin.notification.destroy',$percentage->id) }}" method="POST">
                                            <div class="d-flex align-items-center">
                                                ...
                                                <a href="{{route('admin.notification.edit',$percentage->id)}}"
                                                   class="form-group btn btn-icon btn-primary change-credit-model mb-0 mr-1"
